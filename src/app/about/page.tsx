      ...
      <section className="py-32 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <div className="flex flex-col gap-3 lg:gap-4 h-[800px] lg:h-[1000px] w-full relative">
                ...
                <div className="flex-1 grid grid-cols-3 gap-3 lg:gap-4">
                  <div className="relative rounded-3xl overflow-hidden shadow-sm group">
                    <Image src="/about-collage-2.jpg" alt="Tauby" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
                  </div>
                  <div className="relative rounded-3xl overflow-hidden shadow-sm group">
                  ...
                  <div className="relative rounded-3xl overflow-hidden shadow-sm group">
                    <Image src="/about-collage-5.jpg" alt="Ribbon Cutting" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
                  </div>
                </div>

                {/* MIDDLE ROW: Team photo (horizontal) */}
                <div className="h-[200px] lg:h-[280px] shrink-0 relative rounded-3xl overflow-hidden shadow-premium group">
                  <Image src="/about-collage-1.jpg" alt="Tauby's Team" fill className="object-cover object-[center_35%] transition-transform duration-700 group-hover:scale-105" />
                </div>

                {/* BOTTOM ROW: 3 vertical photos */}
                <div className="flex-1 grid grid-cols-3 gap-3 lg:gap-4">
                  <div className="relative rounded-3xl overflow-hidden shadow-sm group">
                    <Image src="/about-collage-3.jpg" alt="Tasting" fill className="object-cover object-left transition-transform duration-700 group-hover:scale-105" />
                  </div>
                  <div className="relative rounded-3xl overflow-hidden shadow-sm group">
                    <Image src="/about-collage-6.jpg" alt="Tauby's Work" fill className="object-cover object-center transition-transform duration-700 group-hover:scale-105" />
                  </div>
                  <div className="relative rounded-3xl overflow-hidden shadow-sm group">
                    <Image src="/about-collage-7.jpg" alt="Kitchen Prep" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
                  </div>
                </div>

                {/* The 20+ Years Badge */}
                <div className="absolute -bottom-6 -right-6 lg:-bottom-10 lg:-right-10 bg-red-deep p-6 lg:p-10 rounded-[2rem] shadow-2xl text-white hidden md:block z-10">
                  <p className="text-4xl lg:text-5xl font-heading font-bold text-gold mb-1">20+</p>
                  <p className="text-[10px] lg:text-xs uppercase tracking-widest font-bold opacity-80">Years of Legacy</p>
                </div>
              </div>
            </motion.div>
