              ...
              >
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <p className="text-dark-muted text-sm leading-relaxed mb-6">
                    Authentic Italian-style gelato made with the finest ingredients.
                  </p>
                  <div className="mt-auto pt-6 border-t border-dark/5 flex justify-between items-center">
                    <span className="text-red-primary font-bold text-sm tracking-widest uppercase">₹{flavor.price} / 700gm</span>
