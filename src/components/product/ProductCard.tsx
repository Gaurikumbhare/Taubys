      ...
      <Link href={`/product/${id}`} className="block">
        ...
        <div className="relative aspect-[4/5] overflow-hidden bg-cream">
          ...
          <div className="absolute top-4 left-4 flex flex-col gap-2">
            {isEggless && (
              <span className="bg-green-100 text-green-700 text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider flex items-center gap-1 border border-green-200 shadow-sm">
            ...
            {category === "Regular Cakes" ? (
              <span className="bg-red-100 text-red-700 text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider flex items-center gap-1 border border-red-200 shadow-sm">
